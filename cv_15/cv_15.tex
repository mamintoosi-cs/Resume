...
\includegraphics[width=0.8\columnwidth]{me1.jpg}\\[\baselineskip] % Your photo
\small % Smaller font size
\textbf{Morteza Jalambadani}\\ % Your name
\Sep
\url{Morteza@Jalambadani.ir} \\ % Your email address
\url{www.Jalambadani.Ir} \\ % Your URL
(+98) 939 166 1481\\ % Your phone number
\textbf{Address} \\
...
\cvheading{Morteza Jalambadani} % Large heading - your name

\cvheadingColor{Developer}{gray} % Subheading - your occupation/specialization
